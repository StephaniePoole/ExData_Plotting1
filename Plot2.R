...
# Plot function "Global Reactive power" vs time
plot(subset_power$Time,as.numeric(as.character(subset_power$Global_reactive_power)),type="l",xlab="",ylab="Global Active Power (kilowatts)") 

# Add a title to the graph
title(main="Global Reactive Power over Time")
